                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" required accept="image/png, image/jpeg, image/jpg">
                        ...
                        <div class="form-group row">
                            <label for="birthday" enctype="multipart/form-data" class="col-md-4 col-form-label text-md-right">{{ __('Birthday') }}</label>
